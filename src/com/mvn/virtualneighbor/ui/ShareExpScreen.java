...
public class ShareExpScreen extends BaseSlideMenuActivity implements ImportantMethods,OnClickListener{

	// ** Final Variables **\\
	private final String TAG = "ShareExpScreen";
	...
	public void onContentChanged() {
		...
		initialization();
		// Main Screen
		setSlideRole(R.layout.activity_share_exp_screen);
		// Left Menus
