...
public class NeighborhoodWallScreen extends BaseSlideMenuActivity implements
		ImportantMethods, OnClickListener {

	// ** Final Variables **\\
	private final String TAG = "NeighborhoodWallScreen";
	...
	public void onContentChanged() {
		...
		initialization();
		// Main Screen
		setSlideRole(R.layout.activity_neighborhood_wall_screen);
		// Left Menus
