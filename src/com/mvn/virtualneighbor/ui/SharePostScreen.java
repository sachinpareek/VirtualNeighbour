...
public class SharePostScreen extends BaseSlideMenuActivity implements
		ImportantMethods, OnClickListener {

	// ** Final Variables **\\
	private final String TAG = "SharePostScreen";
	...
	public void onContentChanged() {
		...
		initialization();
		// Main Screen
		setSlideRole(R.layout.activity_share_post_screen);
		// Left Menus
