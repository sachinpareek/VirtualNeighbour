...
public class ResharePostScreen extends BaseSlideMenuActivity implements
		ImportantMethods, OnClickListener {

	// ** Final Variables **\\
	private final String TAG = "ResharePostScreen";
	...
	public void onContentChanged() {
		...
		initialization();
		// Main Screen
		setSlideRole(R.layout.activity_reshare_post_screen);
		// Left Menus
